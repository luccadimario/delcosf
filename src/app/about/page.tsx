                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="text-xl md:text-2xl max-w-3xl mx-auto">
                            Celebrating 25 years of scientific discovery and innovation in Delaware County
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 mb-6">
                                The Delco Science Fair exists to inspire and nurture the next generation of scientists, engineers, and innovators. We believe that every student has the potential to make meaningful contributions to our understanding of the world around us.
                            </p>
                            <p className="text-lg text-gray-600 mb-6">
                                Through hands-on experimentation, critical thinking, and scientific inquiry, we empower students to explore their curiosity and develop the skills necessary for success in STEM fields and beyond.
                            </p>
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-blue-50 p-8 rounded-lg">
                            <div className="space-y-8">
                                <div className="text-center">
                                    ...
                                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Innovation Hub</h3>
                                    <p className="text-gray-600">Fostering creativity and scientific thinking</p>
                                </div>
                                <div className="text-center">
                                    ...
                                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Education First</h3>
                                    <p className="text-gray-600">Learning through hands-on experimentation</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            From humble beginnings to Delaware County's premier science education event
                        </p>
                    </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="bg-white p-8 rounded-lg shadow-md">
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-600">
                                        Started with just 50 students from 5 local schools, the first Delco Science Fair was held at the community center with volunteer judges from local universities.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-lg shadow-md">
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-600">
                                        Expanded to include all Delaware County schools with over 300 participants. Introduced special awards for environmental science and technology innovation.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-lg shadow-md">
                                <div className="text-center">
                                    <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                        <span className="text-2xl font-bold text-purple-600">2025</span>
                                    </div>
                                    <h3 className="text-xl font-semibold mb-3">Today</h3>
                                    <p className="text-gray-600">
                                        Now featuring 500+ students annually, with partnerships from major universities and technology companies, inspiring the next generation of innovators.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-500">
                            ...
                            <p className="text-gray-600 text-sm">
                                Molecular interactions, chemical reactions, and material science projects
                            </p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-orange-500">
                            ...
                            <p className="text-gray-600 text-sm">
                                Design challenges, robotics, and innovative engineering solutions
                            </p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-red-500">
                            ...
                            <p className="text-gray-600 text-sm">
                                Statistical analysis, mathematical modeling, and computational projects
                            </p>
                        </div>
            ...
            <section className="py-16 bg-blue-600">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                        Whether you're a student, teacher, parent, or community member, there are many ways to get involved with the Delco Science Fair.
                    </p>
