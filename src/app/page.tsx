      ...
      <div className="min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
                Inspiring the next generation of scientists and innovators in Delaware County
        ...
        <section className="py-16 bg-gray-50 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div
                className="bg-white rounded-lg shadow-md text-center mb-12 p-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">March 15, 2025<br/>9:00 AM - 4:00 PM</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">Delaware County<br/>Community Center</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">Students K-12<br/>Delaware County Schools</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  The Delco Science Fair has been inspiring young minds for over two decades. Our mission is to encourage scientific inquiry, critical thinking, and innovation among students throughout Delaware County.
                </p>
                <p className="text-lg text-gray-600 mb-8">
                  From elementary school experiments to advanced high school research projects, we celebrate all levels of scientific achievement and provide a platform for students to showcase their discoveries.
                </p>
                <Link
                    href="/about"
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-8 rounded-lg">
                <div className="space-y-6">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Student Participants</h4>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Years Running</h4>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Expert Judges</h4>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Hear from students, teachers, and parents about their Science Fair experience
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700 italic">
                  "The Delco Science Fair gave me the confidence to pursue my passion for chemistry. The feedback from judges helped me improve my research skills tremendously!"
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700 italic">
                  "This event brings out the best in our students. I've seen shy kids become confident presenters and curious minds turn into future scientists."
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700 italic">
                  "Watching my daughter present her project with such enthusiasm was incredible. The Science Fair sparked a love for learning that continues to this day."
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-blue-600">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Registration is now open for the 2025 Delco Science Fair. Don't miss your chance to be part of this amazing event!
            </p>
            <Link
                href="/register"
