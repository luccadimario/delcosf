          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                Download the complete requirements and deadlines document
              </p>
              <a
                href="/General Info & Due Dates.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-orange-600 text-white px-3 py-2 rounded text-sm hover:bg-orange-700 transition-colors inline-block"
              >
                Download PDF
              </a>
            </div>
